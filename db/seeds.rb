...
puts "Done! Created #{User.count} users, #{Medication.count} medications, #{Follow.count} follows."
puts "Demo accounts (password: password123): alice@medilink.dev, bob@medilink.dev, carla@medilink.dev, marc@medilink.dev"
